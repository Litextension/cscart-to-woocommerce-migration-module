=== CSCart to WooCommerce Migration ===
...
This plugin allows you to migrate your products, orders, customers, passwords and other data from CSCart to WooCommerce automatically.

== Description ==
This plugin allows you to migrate your products, categories, orders, customers, passwords and other data from CSCart to WooCommerce automatically. 
...
 
= ADDITIONAL FEATURES =
* No Downtime: Data is migrated with no downtime for your current CSCart store
...
* Migrate Recent Data: You have just finished a full migration, after that CSCart is still live and continue getting new data, and you want to get your WooCommerce updated with the new data, this feature to avoid starting over again.
...
* Data Security: Direct data transfer from CSCart to WooCommerce, NO third party involved
...
3. Go to the Plugins -> CSCart to WooCommerce Migration
